...
namespace Redacao.Data.Migrations
{
    ...
    [Migration("20220423130109_pijaowiddja")]
    partial class pijaowiddja
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Redacao.Domain.Entidades.Documento.DocumentoDocumento", b =>
                {
                    ...
                    b.Property<int?>("RedacaoRedacaoId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ChaveValor");

                    b.HasIndex("RedacaoRedacaoId");
            ...
            modelBuilder.Entity("Redacao.Domain.Entidades.Redacao.TemaRedacao", b =>
                {
                    ...
                    b.Property<int>("QuantidadeDeslikes")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Redacao.Domain.Entidades.Documento.DocumentoDocumento", b =>
                {
                    b.HasOne("Redacao.Domain.Entidades.Redacao.RedacaoRedacao", null)
                        .WithMany("DocumentosRedacao")
                        .HasForeignKey("RedacaoRedacaoId");

                    b.HasOne("Redacao.Domain.Entidades.Redacao.TemaRedacao", null)
